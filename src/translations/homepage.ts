...
const homepageTranslations = {
  en: {
    ...
    details:
      "Details are still being finalized, and we'll continue to update this site as plans come together. Formal invitations will be sent out in early 2026.",
    story: 'Our Story',
    howWeMet: 'How We Met',
    howWeMetText:
  ...
  es: {
    ...
    details:
      'Los detalles aún se están finalizando, y continuaremos actualizando este sitio a medida que los planes se concreten. Las invitaciones formales se enviarán a principios de 2026.',
